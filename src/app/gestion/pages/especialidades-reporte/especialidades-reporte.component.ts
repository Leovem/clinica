...
@Component({
  selector: 'app-especialidades-reporte',
  templateUrl: './especialidades-reporte.component.html',
  styleUrls: ['./especialidades-reporte.component.css']
})
export class EspecialidadesReporteComponent implements OnInit {
  ...
  public getFichas() {
    this.fichasService.getFichasSuspendidas()
    .pipe(
      catchError(error => {
